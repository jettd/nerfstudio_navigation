    ...
    if viewing_gsplat:
        ...
        def _(event: viser.GuiEvent) -> None:
            ...
            if harvest_telem_port is not None:
                ...
                # This standalone path is not used in normal Harvest operation — the viewer
                # is always launched with harvest_telem_port set, and output directories are
                # autogenerated by the Rails backend. This fallback command is a best-effort
                # convenience; if you are modifying the splat UI, the harvest path above is
                # what matters.
                command = " ".join(
                    [
